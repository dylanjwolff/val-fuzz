...
def z3(commit):
    def build(commit):
        ...
        os.system("cd .solvers/z3; ./configure; cd build; make -j 12")
...
def cvc4(commit):
    def build(commit):
        ...
        os.system("cd .solvers/cvc4; ./contrib/get-antlr-3.4; ./contrib/get-symfpu; ./configure.sh --symfpu; cd build; make -j 12")
