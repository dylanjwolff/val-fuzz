...
(assert (xor (< GEN1 i0) v0 v4 (str.<= Str8 Str17) v2 v3 v3 v2 v2))
(declare-const v5 Bool)
(assert (xor v5 (= Str3 Str9 Str15 Str16 Str13) v0 v0 (str.<= Str8 Str17) v0 v2))
(assert (not (str.<= Str8 Str17)))
(assert (= BAV2 (xor (< GEN1 i0) v0 v4 (str.<= Str8 Str17) v2 v3 v3 v2 v2)))
(assert (= BAV3 (< GEN1 i0)))
(assert (= BAV4 (xor v5 (= Str3 Str9 Str15 Str16 Str13) v0 v0 (str.<= Str8 Str17) v0 v2)))
(assert (= BAV5 (= Str3 Str9 Str15 Str16 Str13)))
(check-sat)