...
(assert (= BAV215 (= ?NumStacks GEN150)))
(assert (= BAV216 (= ?InitialStack GEN151)))
(assert (= BAV217 (= ?InterruptStack GEN152)))
(assert (= BAV218 (= ?InterruptReserve GEN153)))
(assert (= BAV219 (= ?StackReserve GEN154)))
(assert (= BAV220 (= ?STACK_EMPTY GEN155)))
(assert (= BAV221 (= ?STACK_RUNNING GEN156)))
(assert (= BAV222 (= ?STACK_YIELDED GEN157)))
(assert (= BAV223 (= ?STACK_INTERRUPTED GEN158)))
(assert (= BAV224 (forall ((tag Int)) (= (IsStackStateTag tag) (and (<= GEN159 tag) (<= tag GEN160))))))
(assert (= BAV225 (forall ((tag Int)) (and (<= GEN159 tag) (<= tag GEN160)))))
(assert (= BAV226 (forall ((tag Int)) (<= GEN159 tag))))
(assert (= BAV227 (forall ((tag Int)) (<= tag GEN160))))
(assert (= BAV228 (forall ((tag@@0 Int)(state T@StackState)) (= (IsStackStateTagFor tag@@0 state) (and (IsStackStateTag tag@@0) (= tag@@0 (StackStateTag state)))))))
(assert (= BAV229 (forall ((tag@@0 Int)(state T@StackState)) (and (IsStackStateTag tag@@0) (= tag@@0 (StackStateTag state))))))
(assert (= BAV230 (forall ((tag@@0 Int)(state T@StackState)) (= tag@@0 (StackStateTag state)))))
(assert (= BAV231 (= ?KernelEntryPoint GEN161)))
(assert (= BAV232 (= WORD_HI (+ (+ GEN162 GEN163) GEN164))))
(assert (= BAV233 (=> (! (and %lbl%+6740 true) :lblpos GEN166) (=> (! (and %lbl%+6542 true) :lblpos GEN165) true))))
(assert (= BAV234 (and %lbl%+6740 true)))
(assert (= BAV235 (=> (! (and %lbl%+6542 true) :lblpos GEN165) true)))
(assert (= BAV236 (and %lbl%+6542 true)))
(check-sat)
(get-model)
(pop 1)