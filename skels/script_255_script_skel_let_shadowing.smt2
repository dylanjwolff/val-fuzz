...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 true)) (= BAV5 false)) (= BAV6 true)) (= BAV7 false)) (= BAV8 false)) (= BAV9 false)) (= BAV10 true)) (= BAV11 false)) (= BAV12 true)) (= BAV13 true)) (= BAV14 false)) (= BAV15 false)))
(check-sat)