...
(assert (and (and (and (and (and (and (and (and (and (= BAV1 true) (= BAV2 false)) (= BAV3 false)) (= BAV4 true)) (= BAV5 false)) (= BAV6 false)) (= BAV7 true)) (= BAV8 false)) (= BAV9 false)) (= BAV10 false)))
(check-sat)
(exit)