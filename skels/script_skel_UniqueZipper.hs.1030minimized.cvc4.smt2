...
(assert (and (not (smt_set_mem z3v132 (z3f70 z3v131))) (= (z3f72 z3v131) smt_set_emp) (= (z3f72 z3v133) smt_set_emp) (= (z3f72 z3v242) (ite (smt_set_mem z3v271 (z3f70 z3v270)) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f72 z3v270)) (z3f72 z3v270))) (= (z3f70 z3v242) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f70 z3v270))) (= z3v242 (z3f77 z3v271 z3v270)) (= z3v242 z3v243) (smt_set_sub (z3f70 z3v242) (z3f70 z3v244)) (= (z3f72 z3v242) smt_set_emp) (smt_set_sub (z3f70 z3v243) (z3f70 z3v244)) (= (z3f72 z3v243) smt_set_emp) (= (z3f72 z3v244) (ite (smt_set_mem z3v132 (z3f70 z3v131)) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f72 z3v131)) (z3f72 z3v131))) (= (z3f70 z3v244) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f70 z3v131))) (= (z3f94 z3v134) z3v133) (= (z3f95 z3v134) z3v131) (= z3v134 z3v135) (= (smt_set_cap (z3f70 (z3f94 z3v134)) (z3f70 (z3f95 z3v134))) smt_set_emp) (= (smt_set_cap (z3f70 (z3f94 z3v135)) (z3f70 (z3f95 z3v135))) smt_set_emp) (= z3v272 z3v133) (= (z3f72 z3v272) smt_set_emp) (= (z3f81 z3v80) z3v80) (= (z3f81 z3v82) z3v82) (= (z3f81 z3v83) z3v83)))
(assert (= BAV1 (distinct z3v66 z3v67)))
(assert (= BAV2 (and (not (smt_set_mem z3v132 (z3f70 z3v131))) (= (z3f72 z3v131) smt_set_emp) (= (z3f72 z3v133) smt_set_emp) (= (z3f72 z3v242) (ite (smt_set_mem z3v271 (z3f70 z3v270)) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f72 z3v270)) (z3f72 z3v270))) (= (z3f70 z3v242) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f70 z3v270))) (= z3v242 (z3f77 z3v271 z3v270)) (= z3v242 z3v243) (smt_set_sub (z3f70 z3v242) (z3f70 z3v244)) (= (z3f72 z3v242) smt_set_emp) (smt_set_sub (z3f70 z3v243) (z3f70 z3v244)) (= (z3f72 z3v243) smt_set_emp) (= (z3f72 z3v244) (ite (smt_set_mem z3v132 (z3f70 z3v131)) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f72 z3v131)) (z3f72 z3v131))) (= (z3f70 z3v244) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f70 z3v131))) (= (z3f94 z3v134) z3v133) (= (z3f95 z3v134) z3v131) (= z3v134 z3v135) (= (smt_set_cap (z3f70 (z3f94 z3v134)) (z3f70 (z3f95 z3v134))) smt_set_emp) (= (smt_set_cap (z3f70 (z3f94 z3v135)) (z3f70 (z3f95 z3v135))) smt_set_emp) (= z3v272 z3v133) (= (z3f72 z3v272) smt_set_emp) (= (z3f81 z3v80) z3v80) (= (z3f81 z3v82) z3v82) (= (z3f81 z3v83) z3v83))))
(assert (= BAV3 (= (z3f72 z3v131) smt_set_emp)))
(assert (= BAV4 (= (z3f72 z3v133) smt_set_emp)))
(assert (= BAV5 (= (z3f72 z3v242) (ite (smt_set_mem z3v271 (z3f70 z3v270)) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f72 z3v270)) (z3f72 z3v270)))))
(assert (= BAV6 (= (z3f70 z3v242) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f70 z3v270)))))
(assert (= BAV7 (= z3v242 (z3f77 z3v271 z3v270))))
(assert (= BAV8 (= z3v242 z3v243)))
(assert (= BAV9 (= (z3f72 z3v242) smt_set_emp)))
(assert (= BAV10 (= (z3f72 z3v243) smt_set_emp)))
(assert (= BAV11 (= (z3f72 z3v244) (ite (smt_set_mem z3v132 (z3f70 z3v131)) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f72 z3v131)) (z3f72 z3v131)))))
(assert (= BAV12 (= (z3f70 z3v244) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f70 z3v131)))))
(assert (= BAV13 (= (z3f94 z3v134) z3v133)))
(assert (= BAV14 (= (z3f95 z3v134) z3v131)))
(assert (= BAV15 (= z3v134 z3v135)))
(assert (= BAV16 (= (smt_set_cap (z3f70 (z3f94 z3v134)) (z3f70 (z3f95 z3v134))) smt_set_emp)))
(assert (= BAV17 (= (smt_set_cap (z3f70 (z3f94 z3v135)) (z3f70 (z3f95 z3v135))) smt_set_emp)))
(assert (= BAV18 (= z3v272 z3v133)))
(assert (= BAV19 (= (z3f72 z3v272) smt_set_emp)))
(assert (= BAV20 (= (z3f81 z3v80) z3v80)))
(assert (= BAV21 (= (z3f81 z3v82) z3v82)))
(assert (= BAV22 (= (z3f81 z3v83) z3v83)))
(check-sat)
(get-model)