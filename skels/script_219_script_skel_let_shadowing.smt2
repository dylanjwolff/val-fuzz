...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 true)) (= BAV5 false)) (= BAV6 false)) (= BAV7 true)) (= BAV8 true)) (= BAV9 true)) (= BAV10 true)) (= BAV11 false)) (= BAV12 false)) (= BAV13 false)) (= BAV14 false)) (= BAV15 false)))
(check-sat)