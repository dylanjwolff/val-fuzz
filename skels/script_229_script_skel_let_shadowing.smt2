...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 false)) (= BAV5 true)) (= BAV6 false)) (= BAV7 false)) (= BAV8 false)) (= BAV9 false)) (= BAV10 true)) (= BAV11 true)) (= BAV12 false)) (= BAV13 true)) (= BAV14 false)) (= BAV15 true)))
(check-sat)