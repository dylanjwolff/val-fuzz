...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 true)) (= BAV5 false)) (= BAV6 false)) (= BAV7 true)) (= BAV8 false)) (= BAV9 true)) (= BAV10 false)) (= BAV11 true)) (= BAV12 false)) (= BAV13 true)) (= BAV14 true)) (= BAV15 true)))
(check-sat)