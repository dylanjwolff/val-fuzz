...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 false)) (= BAV5 true)) (= BAV6 true)) (= BAV7 false)) (= BAV8 true)) (= BAV9 true)) (= BAV10 true)) (= BAV11 false)) (= BAV12 true)) (= BAV13 true)) (= BAV14 true)) (= BAV15 false)))
(check-sat)