...
(assert (not (= (a2 (ite (bvsle x0 x1) v2 GEN1)) (bvudiv (bvudiv v4 v5) (bvudiv (bvudiv v3 v4) (bvudiv v3 v5))))))
(assert (= BAV2 (= (a2 (ite (bvsle x0 x1) v2 GEN1)) (bvudiv (bvudiv v4 v5) (bvudiv (bvudiv v3 v4) (bvudiv v3 v5))))))
(check-sat)
(exit)