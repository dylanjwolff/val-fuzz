...
(assert (str.in.re (str.++ var_8 GEN1 var_9) (re.++ (re.* (re.union (str.to.re GEN2) (re.++ (str.to.re GEN3) (re.++ (re.* (re.union (str.to.re GEN4) (str.to.re GEN5))) (str.to.re GEN6))))) (re.++ (str.to.re GEN7) (re.* (re.union (str.to.re GEN8) (str.to.re GEN9)))))))
