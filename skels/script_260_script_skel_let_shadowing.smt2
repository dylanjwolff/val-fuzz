...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 true)) (= BAV5 false)) (= BAV6 true)) (= BAV7 false)) (= BAV8 false)) (= BAV9 true)) (= BAV10 false)) (= BAV11 false)) (= BAV12 false)) (= BAV13 false)) (= BAV14 true)) (= BAV15 false)))
(check-sat)