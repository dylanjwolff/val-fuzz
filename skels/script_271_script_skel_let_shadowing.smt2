...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 true)) (= BAV5 false)) (= BAV6 false)) (= BAV7 false)) (= BAV8 false)) (= BAV9 true)) (= BAV10 true)) (= BAV11 true)) (= BAV12 true)) (= BAV13 true)) (= BAV14 true)) (= BAV15 true)))
(check-sat)