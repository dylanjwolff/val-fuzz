...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 true)) (= BAV5 false)) (= BAV6 true)) (= BAV7 true)) (= BAV8 false)) (= BAV9 false)) (= BAV10 true)) (= BAV11 true)) (= BAV12 false)) (= BAV13 true)) (= BAV14 true)) (= BAV15 false)))
(check-sat)