...
(assert (= x (_ bv85 8)))
(assert (= y (_ bv170 8)))
(assert (= BAV1 (= z1 (concat (concat (concat ((_ extract 0 0) x) ((_ extract 2 2) x)) ((_ extract 4 4) x)) ((_ extract 6 6) x)))))
(assert (= BAV2 (= z2 (concat (concat (concat ((_ extract 7 7) y) ((_ extract 5 5) y)) ((_ extract 3 3) y)) ((_ extract 1 1) y)))))
(assert (= BAV3 (= x (_ bv85 8))))
(assert (= BAV4 (= y (_ bv170 8))))
(assert (= BAV5 (= z1 z2)))
