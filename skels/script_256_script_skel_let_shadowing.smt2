...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 false)) (= BAV5 false)) (= BAV6 true)) (= BAV7 true)) (= BAV8 true)) (= BAV9 false)) (= BAV10 false)) (= BAV11 false)) (= BAV12 true)) (= BAV13 false)) (= BAV14 true)) (= BAV15 true)))
(check-sat)