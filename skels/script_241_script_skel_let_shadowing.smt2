...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 true)) (= BAV5 false)) (= BAV6 true)) (= BAV7 true)) (= BAV8 true)) (= BAV9 false)) (= BAV10 true)) (= BAV11 true)) (= BAV12 true)) (= BAV13 true)) (= BAV14 false)) (= BAV15 false)))
(check-sat)