...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 true)) (= BAV5 true)) (= BAV6 true)) (= BAV7 false)) (= BAV8 false)) (= BAV9 false)) (= BAV10 false)) (= BAV11 false)) (= BAV12 true)) (= BAV13 true)) (= BAV14 true)) (= BAV15 true)))
(check-sat)