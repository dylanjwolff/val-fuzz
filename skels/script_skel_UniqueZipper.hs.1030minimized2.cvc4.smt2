...
(assert (= (z3f72 z3v242) (ite (smt_set_mem z3v271 (z3f70 z3v270)) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f72 z3v270)) (z3f72 z3v270))))
(assert (= (z3f70 z3v242) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f70 z3v270))))
(assert (= z3v242 (z3f77 z3v271 z3v270)))
(assert (= z3v242 z3v243))
(assert (subset (z3f70 z3v242) (z3f70 z3v244)))
(assert (= (z3f72 z3v243) smt_set_emp))
(assert (= (z3f72 z3v244) (ite (smt_set_mem z3v132 (z3f70 z3v131)) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f72 z3v131)) (z3f72 z3v131))))
(assert (= (z3f70 z3v244) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f70 z3v131))))
(assert (= (z3f94 z3v134) z3v133))
(assert (= (z3f95 z3v134) z3v131))
(assert (= z3v134 z3v135))
(assert (= (smt_set_cap (z3f70 (z3f94 z3v135)) (z3f70 (z3f95 z3v135))) smt_set_emp))
...
(assert (= BAV2 (= (z3f72 z3v131) smt_set_emp)))
(assert (= BAV3 (= (z3f72 z3v242) (ite (smt_set_mem z3v271 (z3f70 z3v270)) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f72 z3v270)) (z3f72 z3v270)))))
(assert (= BAV4 (= (z3f70 z3v242) (smt_set_cup (smt_set_add smt_set_emp z3v271) (z3f70 z3v270)))))
(assert (= BAV5 (= z3v242 (z3f77 z3v271 z3v270))))
(assert (= BAV6 (= z3v242 z3v243)))
(assert (= BAV7 (= (z3f72 z3v243) smt_set_emp)))
(assert (= BAV8 (= (z3f72 z3v244) (ite (smt_set_mem z3v132 (z3f70 z3v131)) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f72 z3v131)) (z3f72 z3v131)))))
(assert (= BAV9 (= (z3f70 z3v244) (smt_set_cup (smt_set_add smt_set_emp z3v132) (z3f70 z3v131)))))
(assert (= BAV10 (= (z3f94 z3v134) z3v133)))
(assert (= BAV11 (= (z3f95 z3v134) z3v131)))
(assert (= BAV12 (= z3v134 z3v135)))
(assert (= BAV13 (= (smt_set_cap (z3f70 (z3f94 z3v135)) (z3f70 (z3f95 z3v135))) smt_set_emp)))
(assert (= BAV14 (= z3v272 z3v133)))
(assert (= BAV15 (= (z3f72 z3v272) smt_set_emp)))
(assert (= BAV16 (= (z3f81 z3v80) z3v80)))
(assert (= BAV17 (= (z3f81 z3v82) z3v82)))
(assert (= BAV18 (= (z3f81 z3v83) z3v83)))
(check-sat)
(get-model)