...
(assert (= mpfx (fp.fma roundTowardNegative ((_ to_fp 11 53) roundNearestTiesToEven GEN3 (- GEN4)) ((_ to_fp 11 53) roundNearestTiesToEven (- GEN7) GEN8) ((_ to_fp 11 53) roundNearestTiesToEven (- GEN11) (- GEN12)))))
...
(assert (not (= q mpfx)))
(assert (= BAV1 (= mpfx (fp.fma roundTowardNegative ((_ to_fp 11 53) roundNearestTiesToEven GEN3 (- GEN4)) ((_ to_fp 11 53) roundNearestTiesToEven (- GEN7) GEN8) ((_ to_fp 11 53) roundNearestTiesToEven (- GEN11) (- GEN12))))))
...
(assert (= BAV5 (= q (fp.fma roundTowardNegative x y z))))
(assert (= BAV6 (= q mpfx)))
(check-sat)
(get-model)
(check-sat-using smt)