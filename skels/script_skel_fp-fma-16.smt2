...
(assert (= mpfq (fp.fma roundTowardZero ((_ to_fp 11 53) roundNearestTiesToEven GEN3 (- GEN4)) ((_ to_fp 11 53) roundNearestTiesToEven GEN7 GEN8) ((_ to_fp 11 53) roundNearestTiesToEven (- GEN11) (- GEN12)))))
...
(assert (not (= q r)))
(assert (= BAV1 (= mpfq (fp.fma roundTowardZero ((_ to_fp 11 53) roundNearestTiesToEven GEN3 (- GEN4)) ((_ to_fp 11 53) roundNearestTiesToEven GEN7 GEN8) ((_ to_fp 11 53) roundNearestTiesToEven (- GEN11) (- GEN12))))))
