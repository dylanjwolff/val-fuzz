...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 true)) (= BAV5 false)) (= BAV6 true)) (= BAV7 true)) (= BAV8 true)) (= BAV9 false)) (= BAV10 true)) (= BAV11 false)) (= BAV12 false)) (= BAV13 false)) (= BAV14 true)) (= BAV15 true)))
(check-sat)