...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 false)) (= BAV5 false)) (= BAV6 false)) (= BAV7 true)) (= BAV8 false)) (= BAV9 false)) (= BAV10 true)) (= BAV11 false)) (= BAV12 false)) (= BAV13 false)) (= BAV14 true)) (= BAV15 true)))
(check-sat)