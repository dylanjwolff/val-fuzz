...
(assert (= BAV16 (forall ((x U)(y Int)(z V)(w Int)(v U)(d Int)) (=> (and (<= GEN1 d GEN2) (<= GEN3 y GEN4) (<= GEN5 w (+ GEN6 y))) (P x y z w v d)))))
(assert (= BAV17 (forall ((x U)(y Int)(z V)(w Int)(v U)(d Int)) (and (<= GEN1 d GEN2) (<= GEN3 y GEN4) (<= GEN5 w (+ GEN6 y))))))
(assert (= BAV18 (forall ((x U)(y Int)(z V)(w Int)(v U)(d Int)) (<= GEN1 d GEN2))))
