...
(assert (not (= (a2 (ite (bvult x0 x1) v2 GEN2)) (bvudiv (bvudiv v4 v5) (bvudiv (bvudiv v3 v4) (bvudiv v3 v5))))))
(assert (= BAV1 (= x0 (_ bv1022 10))))
(assert (= BAV2 (= (a2 (ite (bvult x0 x1) v2 GEN2)) (bvudiv (bvudiv v4 v5) (bvudiv (bvudiv v3 v4) (bvudiv v3 v5))))))
(check-sat)
(get-model)
(exit)