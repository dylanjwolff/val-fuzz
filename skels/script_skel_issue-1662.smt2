...
(assert (= BAV1 (= true (= sv1 sv2))))
(assert (= BAV2 (= sv1 sv2)))
(assert (= BAV3 (= true (str.in.re var (re.++ (re.++ (re.++ (re.++ (re.* re.allchar) (re.++ (str.to.re GEN1) (re.++ (re.+ (str.to.re GEN2)) (re.++ (re.union (str.to.re GEN3) (str.to.re GEN4)) (re.++ (re.union (str.to.re GEN5) (str.to.re GEN6)) (re.++ (re.+ (str.to.re GEN7)) (str.to.re GEN8))))))) (str.to.re sv1)) (re.++ (re.++ (str.to.re GEN9) (re.++ (re.* re.allchar) (re.++ (str.to.re GEN10) (re.++ (re.* re.allchar) (str.to.re GEN11))))) (str.to.re sv2))) (re.++ (str.to.re GEN12) (re.++ (re.* (str.to.re GEN13)) (re.union (re.++ (str.to.re GEN14) (str.to.re GEN15)) (str.to.re GEN16)))))))))
(check-sat)
(get-model)