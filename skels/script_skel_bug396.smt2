...
(assert (= BAV1 (= (ite (= group_size_y GEN1) GEN2 GEN3) GEN4)))
(assert (= BAV2 (= group_size_y GEN1)))
(assert (= BAV3 (= (ite (= group_size_z GEN5) GEN6 GEN7) GEN8)))
(assert (= BAV4 (= group_size_z GEN5)))
(assert (= BAV5 (= (ite (= num_groups_y GEN9) GEN10 GEN11) GEN12)))
(assert (= BAV6 (= num_groups_y GEN9)))
(assert (= BAV7 (= (ite (= num_groups_z GEN13) GEN14 GEN15) GEN16)))
(assert (= BAV8 (= num_groups_z GEN13)))
(assert (= BAV9 (= (ite (= group_size_x GEN17) GEN18 GEN19) GEN20)))
(assert (= BAV10 (= group_size_x GEN17)))
(assert (= BAV11 (= (ite (= num_groups_x GEN21) GEN22 GEN23) GEN24)))
(assert (= BAV12 (= num_groups_x GEN21)))
(assert (= BAV13 (=> (and true _b0 _b1 _b2 _b3 _b4 _b5 _b6 _b7 _b8 _b9 _b10 _b11) $nbody_sim)))
(assert (= BAV14 (and true _b0 _b1 _b2 _b3 _b4 _b5 _b6 _b7 _b8 _b9 _b10 _b11)))
(assert (= BAV15 (= (ControlFlow GEN25 GEN26) (- GEN27))))
(assert (= BAV16 (= (ControlFlow GEN28 GEN29) (- GEN30))))
(assert (= BAV17 (= (ControlFlow 0 5843) (- 20204))))
(assert (= BAV18 (= (ControlFlow 0 8973) (- 28090))))
(assert (= BAV19 (=> (and true _b0 _b1 _b2 (not _b3) (not _b4) (not _b5) _b6 _b7 _b8 _b9 _b10 _b11) $nbody_sim)))
(assert (= BAV20 (and true _b0 _b1 _b2 (not _b3) (not _b4) (not _b5) _b6 _b7 _b8 _b9 _b10 _b11)))
(assert (= BAV21 (= (ControlFlow 0 8973) (- 28118))))
(assert (= BAV22 (= (ControlFlow 0 8973) (- 28132))))
(assert (= BAV23 (= (ControlFlow 0 5843) (- 20234))))
(assert (= BAV24 (= (ControlFlow 0 5843) (- 20220))))
(check-sat)
(get-model)
