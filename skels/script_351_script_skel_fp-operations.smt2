...
(assert (and (and (and (and (and (and (and (and (and (= BAV1 true) (= BAV2 false)) (= BAV3 false)) (= BAV4 false)) (= BAV5 true)) (= BAV6 false)) (= BAV7 false)) (= BAV8 false)) (= BAV9 false)) (= BAV10 true)))
(check-sat)
(exit)