...
(assert (= (z3f76 z3v375) (z3f76 z3v331)))
(assert (= (z3f76 z3v375) (z3f76 z3v328)))
(assert (> (z3f76 z3v375) GEN1))
(assert (= z3v375 z3v331))
(assert (>= (z3f76 z3v375) GEN2))
(assert (and (>= (z3f76 z3v327) GEN3) (>= (z3f76 z3v328) GEN4) (= (z3f97 z3v328) (smt_set_cup (smt_set_add smt_set_emp z3v329) (z3f97 z3v330))) (= (z3f76 z3v328) (+ GEN5 (z3f76 z3v330))) (= (z3f98 z3v328) false) (= z3v328 (z3f179 z3v329 z3v330)) (>= (z3f76 z3v328) GEN6) (= z3v328 z3v331) (>= (z3f76 z3v328) GEN7) (>= (z3f76 z3v330) GEN8) (>= (z3f76 z3v331) GEN9) (z3f62 z3v60) (= (z3f64 z3v63) z3v63) (= (z3f64 z3v65) z3v65) (not (z3f62 z3v61)) (= (z3f64 z3v66) z3v66)))
(assert (not (= (z3f97 z3v327) (smt_set_cup (z3f97 z3v327) (z3f97 z3v375)))))
(assert (= BAV1 (distinct z3v60 z3v61)))
(assert (= BAV2 (= (z3f97 z3v328) (smt_set_cup (z3f97 z3v331) (z3f97 z3v375)))))
(assert (= BAV3 (= (z3f97 z3v328) (smt_set_cup (z3f97 z3v330) (z3f97 z3v375)))))
(assert (= BAV4 (= (z3f97 z3v328) (smt_set_cup (z3f97 z3v328) (z3f97 z3v375)))))
(assert (= BAV5 (= (z3f97 z3v328) (smt_set_cup (z3f97 z3v327) (z3f97 z3v375)))))
(assert (= BAV6 (= (z3f97 z3v331) (smt_set_cup (z3f97 z3v331) (z3f97 z3v375)))))
(assert (= BAV7 (= (z3f97 z3v331) (smt_set_cup (z3f97 z3v330) (z3f97 z3v375)))))
(assert (= BAV8 (= (z3f97 z3v331) (smt_set_cup (z3f97 z3v328) (z3f97 z3v375)))))
(assert (= BAV9 (= (z3f97 z3v331) (smt_set_cup (z3f97 z3v327) (z3f97 z3v375)))))
(assert (= BAV10 (= (z3f97 z3v375) (z3f97 z3v331))))
(assert (= BAV11 (= (z3f97 z3v375) (z3f97 z3v328))))
(assert (= BAV12 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v327) (z3f97 z3v331)))))
(assert (= BAV13 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v327) (z3f97 z3v328)))))
(assert (= BAV14 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v328) (z3f97 z3v331)))))
(assert (= BAV15 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v328) (z3f97 z3v330)))))
(assert (= BAV16 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v328) (z3f97 z3v328)))))
(assert (= BAV17 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v328) (z3f97 z3v327)))))
(assert (= BAV18 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v330) (z3f97 z3v331)))))
(assert (= BAV19 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v330) (z3f97 z3v328)))))
(assert (= BAV20 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v331) (z3f97 z3v331)))))
(assert (= BAV21 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v331) (z3f97 z3v330)))))
(assert (= BAV22 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v331) (z3f97 z3v328)))))
(assert (= BAV23 (= (z3f97 z3v375) (smt_set_cup (z3f97 z3v331) (z3f97 z3v327)))))
(assert (= BAV24 (<= z3v375 z3v331)))
(assert (= BAV25 (<= z3v375 z3v328)))
(assert (= BAV26 (= z3v375 z3v328)))
(assert (= BAV27 (>= z3v375 z3v331)))
(assert (= BAV28 (>= z3v375 z3v328)))
(assert (= BAV29 (= z3v375 z3v330)))
(assert (= BAV30 (= z3v375 z3v327)))
(assert (= BAV31 (<= (z3f76 z3v375) (z3f76 z3v331))))
(assert (= BAV32 (<= (z3f76 z3v375) (z3f76 z3v328))))
(assert (= BAV33 (> (z3f76 z3v375) (z3f76 z3v330))))
(assert (= BAV34 (> (z3f76 z3v375) (z3f76 z3v327))))
(assert (= BAV35 (>= (z3f76 z3v375) (z3f76 z3v331))))
(assert (= BAV36 (>= (z3f76 z3v375) (z3f76 z3v330))))
(assert (= BAV37 (>= (z3f76 z3v375) (z3f76 z3v328))))
(assert (= BAV38 (>= (z3f76 z3v375) (z3f76 z3v327))))
(assert (= BAV39 (= (z3f76 z3v375) (z3f76 z3v331))))
(assert (= BAV40 (= (z3f76 z3v375) (z3f76 z3v328))))
(assert (= BAV41 (> (z3f76 z3v375) GEN1)))
(assert (= BAV42 (= z3v375 z3v331)))
(assert (= BAV43 (>= (z3f76 z3v375) GEN2)))
(assert (= BAV44 (and (>= (z3f76 z3v327) GEN3) (>= (z3f76 z3v328) GEN4) (= (z3f97 z3v328) (smt_set_cup (smt_set_add smt_set_emp z3v329) (z3f97 z3v330))) (= (z3f76 z3v328) (+ GEN5 (z3f76 z3v330))) (= (z3f98 z3v328) false) (= z3v328 (z3f179 z3v329 z3v330)) (>= (z3f76 z3v328) GEN6) (= z3v328 z3v331) (>= (z3f76 z3v328) GEN7) (>= (z3f76 z3v330) GEN8) (>= (z3f76 z3v331) GEN9) (z3f62 z3v60) (= (z3f64 z3v63) z3v63) (= (z3f64 z3v65) z3v65) (not (z3f62 z3v61)) (= (z3f64 z3v66) z3v66))))
(assert (= BAV45 (>= (z3f76 z3v327) GEN3)))
(assert (= BAV46 (>= (z3f76 z3v328) GEN4)))
(assert (= BAV47 (= (z3f97 z3v328) (smt_set_cup (smt_set_add smt_set_emp z3v329) (z3f97 z3v330)))))
(assert (= BAV48 (= (z3f76 z3v328) (+ GEN5 (z3f76 z3v330)))))
(assert (= BAV49 (= (z3f98 z3v328) false)))
(assert (= BAV50 (= z3v328 (z3f179 z3v329 z3v330))))
(assert (= BAV51 (>= (z3f76 z3v328) GEN6)))
(assert (= BAV52 (= z3v328 z3v331)))
(assert (= BAV53 (>= (z3f76 z3v328) GEN7)))
(assert (= BAV54 (>= (z3f76 z3v330) GEN8)))
(assert (= BAV55 (>= (z3f76 z3v331) GEN9)))
(assert (= BAV56 (= (z3f64 z3v63) z3v63)))
(assert (= BAV57 (= (z3f64 z3v65) z3v65)))
(assert (= BAV58 (= (z3f64 z3v66) z3v66)))
(assert (= BAV59 (= (z3f97 z3v327) (smt_set_cup (z3f97 z3v327) (z3f97 z3v375)))))
(check-sat)
(get-model)