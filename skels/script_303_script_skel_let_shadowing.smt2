...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 false)) (= BAV5 true)) (= BAV6 false)) (= BAV7 false)) (= BAV8 true)) (= BAV9 true)) (= BAV10 true)) (= BAV11 false)) (= BAV12 false)) (= BAV13 true)) (= BAV14 false)) (= BAV15 true)))
(check-sat)