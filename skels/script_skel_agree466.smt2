...
(assert (not (=> (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN12))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))) (=> (= phase comp_phase) (=> (not (= (select comp_done compute$n) Truth)) (=> (= my_compute$result$1 (select global_state compute$n)) (=> (= global_state$1 (store global_state compute$n my_compute$result$1)) (=> (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity)) (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth))))))))))
...
(assert (= BAV96 (=> (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN12))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))) (=> (= phase comp_phase) (=> (not (= (select comp_done compute$n) Truth)) (=> (= my_compute$result$1 (select global_state compute$n)) (=> (= global_state$1 (store global_state compute$n my_compute$result$1)) (=> (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity)) (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth))))))))))
(assert (= BAV97 (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN12))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))))
(assert (= BAV98 (forall ((n node$type)) (and (= (select chosen n) Truth) (= round (+ t GEN12))))))
(assert (= BAV99 (forall ((n node$type)) (= (select chosen n) Truth))))
(assert (= BAV100 (forall ((n node$type)) (= round (+ t GEN12)))))
(assert (= BAV101 (forall ((n node$type)) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))
(assert (= BAV102 (forall ((n node$type)(n node$type)(m node$type)) (= (select (select send_done n) m) Truth))))
(assert (= BAV103 (forall ((n node$type)(n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))
(assert (= BAV104 (=> (= phase comp_phase) (=> (not (= (select comp_done compute$n) Truth)) (=> (= my_compute$result$1 (select global_state compute$n)) (=> (= global_state$1 (store global_state compute$n my_compute$result$1)) (=> (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity)) (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth)))))))))
(assert (= BAV105 (= phase comp_phase)))
(assert (= BAV106 (=> (not (= (select comp_done compute$n) Truth)) (=> (= my_compute$result$1 (select global_state compute$n)) (=> (= global_state$1 (store global_state compute$n my_compute$result$1)) (=> (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity)) (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth))))))))
(assert (= BAV107 (= (select comp_done compute$n) Truth)))
(assert (= BAV108 (=> (= my_compute$result$1 (select global_state compute$n)) (=> (= global_state$1 (store global_state compute$n my_compute$result$1)) (=> (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity)) (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth)))))))
(assert (= BAV109 (= my_compute$result$1 (select global_state compute$n))))
(assert (= BAV110 (=> (= global_state$1 (store global_state compute$n my_compute$result$1)) (=> (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity)) (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth))))))
(assert (= BAV111 (= global_state$1 (store global_state compute$n my_compute$result$1))))
(assert (= BAV112 (=> (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity)) (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth)))))
(assert (= BAV113 (= my_can_decide$result$1 (ite (= round (+ t GEN13)) Truth Falsity))))
(assert (= BAV114 (= round (+ t GEN13))))
(assert (= BAV115 (=> (= compute$can_decide$0$1 my_can_decide$result$1) (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth))))
(assert (= BAV116 (= compute$can_decide$0$1 my_can_decide$result$1)))
(assert (= BAV117 (= (ite (= compute$can_decide$0$1 Truth) (ite (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))) Truth Falsity) (ite (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))) Truth Falsity)) Truth)))
(assert (= BAV118 (= compute$can_decide$0$1 Truth)))
(assert (= BAV119 (=> (= my_decide$result$1 (choose (select global_state$1 compute$n))) (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))))))))
(assert (= BAV120 (= my_decide$result$1 (choose (select global_state$1 compute$n)))))
(assert (= BAV121 (=> (= output$1 (store output compute$n my_decide$result$1)) (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))))
(assert (= BAV122 (= output$1 (store output compute$n my_decide$result$1))))
(assert (= BAV123 (=> (= chosen$1 (store chosen compute$n Truth)) (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))))))
(assert (= BAV124 (= chosen$1 (store chosen compute$n Truth))))
(assert (= BAV125 (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))
(assert (= BAV126 (= comp_done$1 (store comp_done compute$n Truth))))
(assert (= BAV127 (forall ((n node$type)) (=> (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))))
(assert (= BAV128 (forall ((n node$type)) (and (= (select chosen$1 n) Truth) (= round (+ t GEN14))))))
(assert (= BAV129 (forall ((n node$type)) (= (select chosen$1 n) Truth))))
(assert (= BAV130 (forall ((n node$type)) (= round (+ t GEN14)))))
(assert (= BAV131 (forall ((n node$type)) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))
(assert (= BAV132 (forall ((n node$type)(n node$type)(m node$type)) (= (select (select send_done n) m) Truth))))
(assert (= BAV133 (forall ((n node$type)(n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))
(assert (= BAV134 (=> (= comp_done$1 (store comp_done compute$n Truth)) (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))))
(assert (= BAV135 (= comp_done$1 (store comp_done compute$n Truth))))
(assert (= BAV136 (forall ((n node$type)) (=> (and (= (select chosen n) Truth) (= round (+ t GEN15))) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth)))))))
(assert (= BAV137 (forall ((n node$type)) (and (= (select chosen n) Truth) (= round (+ t GEN15))))))
(assert (= BAV138 (forall ((n node$type)) (= (select chosen n) Truth))))
(assert (= BAV139 (forall ((n node$type)) (= round (+ t GEN15)))))
(assert (= BAV140 (forall ((n node$type)) (and (forall ((n node$type)(m node$type)) (= (select (select send_done n) m) Truth)) (forall ((n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))))
(assert (= BAV141 (forall ((n node$type)(n node$type)(m node$type)) (= (select (select send_done n) m) Truth))))
(assert (= BAV142 (forall ((n node$type)(n node$type)(m node$type)) (= (select (select recv_done n) m) Truth))))
(check-sat)
(get-model)