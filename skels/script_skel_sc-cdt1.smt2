...
(assert (= nun_sk_0 (node (lcons_tree (leaf nun_sk_1) (lcons_tree (leaf nun_sk_2) (lcons_tree nun_sk_0 lnil_tree))))))
(assert (= BAV1 (= nun_sk_0 (node (lcons_tree (leaf nun_sk_1) (lcons_tree (leaf nun_sk_2) (lcons_tree nun_sk_0 lnil_tree)))))))
(check-sat)
(get-model)