...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 false)) (= BAV5 true)) (= BAV6 false)) (= BAV7 true)) (= BAV8 true)) (= BAV9 true)) (= BAV10 true)) (= BAV11 true)) (= BAV12 false)) (= BAV13 true)) (= BAV14 false)) (= BAV15 false)))
(check-sat)