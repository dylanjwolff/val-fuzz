...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 true)) (= BAV5 false)) (= BAV6 true)) (= BAV7 true)) (= BAV8 true)) (= BAV9 true)) (= BAV10 true)) (= BAV11 false)) (= BAV12 true)) (= BAV13 false)) (= BAV14 false)) (= BAV15 true)))
(check-sat)