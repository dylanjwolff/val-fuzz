...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 false)) (= BAV5 false)) (= BAV6 false)) (= BAV7 true)) (= BAV8 true)) (= BAV9 false)) (= BAV10 false)) (= BAV11 true)) (= BAV12 false)) (= BAV13 false)) (= BAV14 false)) (= BAV15 true)))
(check-sat)