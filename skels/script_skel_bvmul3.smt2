...
(assert (not (= (a2 (ite (= (bvmul x0 (_ bv15 10)) ((_ extract 9 0) v3)) v2 GEN4)) (bvudiv (bvudiv v4 v5) (bvudiv (bvudiv v3 v4) (bvudiv v3 v5))))))
(assert (= BAV1 (= (a2 (ite (= (bvmul x0 (_ bv15 10)) ((_ extract 9 0) v3)) v2 GEN4)) (bvudiv (bvudiv v4 v5) (bvudiv (bvudiv v3 v4) (bvudiv v3 v5))))))
(assert (= BAV2 (= (bvmul x0 (_ bv15 10)) ((_ extract 9 0) v3))))
(check-sat)
(get-model)
(exit)