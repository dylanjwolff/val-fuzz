...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 false)) (= BAV5 true)) (= BAV6 true)) (= BAV7 false)) (= BAV8 false)) (= BAV9 false)) (= BAV10 false)) (= BAV11 false)) (= BAV12 true)) (= BAV13 true)) (= BAV14 true)) (= BAV15 false)))
(check-sat)