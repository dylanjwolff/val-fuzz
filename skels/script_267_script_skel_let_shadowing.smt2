...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 false) (= BAV4 false)) (= BAV5 false)) (= BAV6 true)) (= BAV7 false)) (= BAV8 false)) (= BAV9 true)) (= BAV10 false)) (= BAV11 true)) (= BAV12 true)) (= BAV13 false)) (= BAV14 true)) (= BAV15 false)))
(check-sat)