...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (= BAV3 true) (= BAV4 false)) (= BAV5 true)) (= BAV6 false)) (= BAV7 true)) (= BAV8 true)) (= BAV9 false)) (= BAV10 false)) (= BAV11 false)) (= BAV12 false)) (= BAV13 true)) (= BAV14 false)) (= BAV15 false)))
(check-sat)